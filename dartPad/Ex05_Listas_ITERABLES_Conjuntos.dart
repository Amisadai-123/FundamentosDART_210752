void main() {
  ...
  print("Confirmamamos el tipo de dato para NUMEROSALREVES que es: ${numerosAlreves.runtimeType}");
  print("De igual manera podemos transormar una LISTA en ITERABLE y viceversa");
  print("Convertimos el ITERABLE a LIST usando .toList(): ${numerosAlreves.toList()} y verificamos su tipo de dato ${numerosAlreves.toList().runtimeType}");
